...
contract SimpleManager is OwnableUpgradeable {
    ...
    function initManagement(SetupParams calldata params) external onlyOwner {
        ...
        require(params.maxSlippage <= hundredPercent / 10, "MS");
    ...
    /// @dev method is identical to ArrakisV2StaticManager.withdrawAndCollectFees
    /// @param vaults_ array of vaults where to collect fees
    /// @param tokens_ array of tokens to collect
