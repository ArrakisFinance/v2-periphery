...
//       resolver
//     );
//     console.log("after deploy vault");
...
//     console.log("before get funds");
//     await getFundsFromFaucet(addresses.faucetWeth, token0, walletAddress);

//     await getFundsFromFaucet(addresses.faucetDai, token1, walletAddress);
//     console.log("before create gauge");
